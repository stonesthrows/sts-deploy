...
// Engine (state + render/collect functions) lives in js/ring-fields.js,
// shared with the desktop workflow app's Edit Order modal — this is just
// the intake-only wiring: re-render the bottom parameter sheet after
// applying the piece type, since it drops its own ring-size/stamping/
