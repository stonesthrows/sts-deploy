...
var CATALOG = [
  {id:'rg_107374',sup:'rg',cat:'Metals — Wire',name:'14/20 Yellow Gold-Filled Round Wire, 16-Ga., Dead-Soft',desc:'By the foot'},
  {id:'rg_108314',sup:'rg',cat:'Metals — Wire',name:'Argentium® Silver Round Wire, 14-Ga., Dead-Soft',desc:'By the foot'},
  {id:'rg_108316',sup:'rg',cat:'Metals — Wire',name:'Argentium® Silver Round Wire, 16-Ga., Dead-Soft',desc:'By the foot'},
  {id:'rg_108318',sup:'rg',cat:'Metals — Wire',name:'Argentium® Silver Round Wire, 18-Ga., Dead-Soft',desc:'By the foot'},
  {id:'rg_108320',sup:'rg',cat:'Metals — Wire',name:'Argentium® Silver Round Wire, 20-Ga., Dead-Soft',desc:'By the foot'},
  {id:'rg_108720',sup:'rg',cat:'Metals — Wire',name:'Argentium® Silver Round Wire, 20-Ga., 1/2-Hard',desc:'By the foot'},
  {id:'rg_107375',sup:'rg',cat:'Metals — Wire',name:'14/20 Yellow Gold-Filled Round Wire, 18-Ga., Dead-Soft',desc:'By the foot'},
  {id:'rg_107376',sup:'rg',cat:'Metals — Wire',name:'14/20 Yellow Gold-Filled Round Wire, 20-Ga., Dead-Soft',desc:'By the foot'},
  {id:'rg_107820',sup:'rg',cat:'Metals — Wire',name:'14/20 Yellow Gold-Filled Round Wire, 20-Ga., 1/2-Hard',desc:'By the foot'},
  {id:'rg_600118',sup:'rg',cat:'Metals — Wire',name:'14K Yellow Gold Round Wire, 18-Ga., Soft',desc:'By the foot'},
  {id:'rg_604120',sup:'rg',cat:'Metals — Wire',name:'18K Yellow Gold Round Wire, 20-Ga., Soft',desc:'By the foot'},
  ...
  {id:'rg_108312',sup:'rg',cat:'Metals — Wire',name:'Argentium® Silver Round Wire, 12-Ga., Dead-Soft',desc:'By the foot'},
  {id:'rg_101528',sup:'rg',cat:'Metals — Wire',name:'14/20 Yellow Gold-Filled Bead Wire, .060"',desc:'By the foot'},
  ...
  {id:'rg_600116',sup:'rg',cat:'Metals — Wire',name:'14K Yellow Gold Round Wire, 16-Ga., Soft',desc:'By the foot'},
  ...
  {id:'rg_100914',sup:'rg',cat:'Metals — Wire',name:'Sterling Silver Bead Wire, 14-Ga.',desc:'By the foot'},
  {id:'rg_613754',sup:'rg',cat:'Findings & Clasps',name:'Sterling Silver 10.1mm Lobster Clasp',desc:'Per piece'},
  {id:'rg_603116',sup:'rg',cat:'Metals — Wire',name:'14K Rose Gold Round Wire, 16-Ga., Soft',desc:'By the foot'},
  ...
  {id:'rg_107301',sup:'rg',cat:'Metals — Wire',name:'14/20 Rose Gold-Filled Round Wire, 18-Ga., Dead-Soft',desc:'By the foot'},
  {id:'rg_107372',sup:'rg',cat:'Metals — Wire',name:'14/20 Yellow Gold-Filled Round Wire, 12-Ga., Dead-Soft',desc:'By the foot'},
  {id:'rg_926876',sup:'rg',cat:'Findings & Clasps',name:'Argentium® Silver 1.6mm ID Round Jump Ring',desc:'20 ga, per pack'},
  {id:'rg_600120',sup:'rg',cat:'Metals — Wire',name:'14K Yellow Gold Round Wire, 20-Ga., Soft',desc:'By the foot'},
  {id:'rg_101526',sup:'rg',cat:'Metals — Wire',name:'14/20 Yellow Gold-Filled Bead Wire, .075"',desc:'By the foot'},
  {id:'rg_615831B',sup:'rg',cat:'Chains',name:'Sterling Silver 1.7mm Cable w/ Tube Beads Chain',desc:'By the foot'},
  {id:'rg_107302',sup:'rg',cat:'Metals — Wire',name:'14/20 Rose Gold-Filled Round Wire, 20-Ga., Dead-Soft',desc:'By the foot'},
  {id:'rg_101529',sup:'rg',cat:'Metals — Wire',name:'14/20 Yellow Gold-Filled Bead Wire, .093"',desc:'By the foot'},
  ...
  {id:'rg_101523',sup:'rg',cat:'Metals — Wire',name:'Sterling Silver Bead Wire, .060"',desc:'By the foot'},
  {id:'rg_628672B',sup:'rg',cat:'Chains',name:'14/20 Yellow Gold-Filled 1.7mm Long & Short Flat Chain',desc:'By the foot'},
  {id:'rg_100912',sup:'rg',cat:'Metals — Wire',name:'Sterling Silver Bead Wire, 12-Ga.',desc:'By the foot'},
  {id:'rg_107300',sup:'rg',cat:'Metals — Wire',name:'14/20 Rose Gold-Filled Round Wire, 16-Ga., Dead-Soft',desc:'By the foot'},
  {id:'rg_108224',sup:'rg',cat:'Metals — Sheet & Stock',name:'Argentium® Silver 6" Sheet, 24-Ga., Dead-Soft',desc:'By the OZT, cut to order'},
  {id:'rg_603120',sup:'rg',cat:'Metals — Wire',name:'14K Rose Gold Round Wire, 20-Ga., Soft',desc:'By the foot'},
  ...
  {id:'rg_101521',sup:'rg',cat:'Metals — Wire',name:'Sterling Silver Bead Wire, .093"',desc:'By the foot'},
  {id:'rg_108716',sup:'rg',cat:'Metals — Wire',name:'Argentium® Silver Round Wire, 16-Ga., 1/2-Hard',desc:'By the foot'},
  {id:'rg_601118',sup:'rg',cat:'Metals — Wire',name:'14K White Gold Round Wire, 18-Ga., Soft (Contains Nickel)',desc:'By the foot'},
  {id:'rg_108924',sup:'rg',cat:'Metals — Wire',name:'Argentium® Silver Round Wire, 24-Ga., Hard',desc:'By the foot'},
  {id:'rg_621644B',sup:'rg',cat:'Chains',name:'Sterling Silver 2.4mm Open Foxtail Chain',desc:'By the foot'},
  {id:'rg_100910',sup:'rg',cat:'Metals — Wire',name:'Sterling Silver Bead Wire, 10-Ga.',desc:'By the foot'},
