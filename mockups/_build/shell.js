...
.k-col{
  /* 144px keeps all eight stages on screen at laptop width, the way the
...
// `mockupBody` is the shell without the <html>/<head> wrapper — the
// all-in-one builder reuses it so the single-page version and the ten
// standalone files render byte-identical markup.
function mockupBody() {
  return `${sidebar()}
    <div class="main">
      ${topbar()}
...
module.exports = { page, esc, STRUCTURE, mockupBody };
